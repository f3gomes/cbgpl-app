      ...
      <div className="flex min-h-screen w-full flex-col bg-gray-50">
        ...
        <main className="mx-auto flex w-full flex-grow flex-col justify-center gap-4 p-4 xl:flex-row">
          ...
          <div className="flex=col w-full rounded-md bg-white p-6 shadow-lg">
            <div className="relative flex h-[120px] w-full items-center justify-center rounded-[27px] bg-[#35246F] px-4 py-2 shadow-xl">
              <button
                type="button"
              ...
              {/* Texto centralizado */}
              <h2 className="w-[572px] text-[25px] font-bold text-white">
                Palestra: IA e o futuro da profissão em gestão de projetos
              </h2>
            </div>

            <div className="h-[665px] w-[665px]">
